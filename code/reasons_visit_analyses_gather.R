...
png ("results/reasons_visit/places_all_regions_gather.png", units="in", width=6, height=5.9, res=500)
...
for (i in 1:nrow(dongou_visited)){
  ...
  reason <- str_detect("gather_food|gather_raw_mat|gather_medicinal_plants|get_water|search_fire", my_reasons)
...
times_gather <- vector(length=nrow(visits_dist_dongou))
...
visits_dist_dongou$total_gather <- times_gather
...
write.csv(visits_dist_dongou, "results/reasons_visit/visits_distances_dongou_max_gather.csv")
write.csv(visits_dist_macao_22, "results/reasons_visit/visits_distances_macao_22_max_gather.csv")
write.csv(visits_dist_macao_23, "results/reasons_visit/visits_distances_macao_23_max_gather.csv")
write.csv(visits_dist_enyelle, "results/reasons_visit/visits_distances_enyelle_max_gather.csv")
write.csv(visits_dist_betou, "results/reasons_visit/visits_distances_betou_max_gather.csv")
write.csv(visits_dist_minganga_22, "results/reasons_visit/visits_distances_minganga_22_max_gather.csv")
write.csv(visits_dist_minganga_23, "results/reasons_visit/visits_distances_minganga_23_max_gather.csv")
...
write.csv(visits_dist_all, "results/reasons_visit/dist_everyone_gather.csv")

# READ IN DATA
visits_dist_dongou <- read.csv("results/reasons_visit/visits_distances_dongou_max_gather.csv")[,-c(1:6,8:9)]
visits_dist_macao_22 <- read.csv("results/reasons_visit/visits_distances_macao_22_max_gather.csv")[,-c(1:6,8:9)]
visits_dist_macao_23 <- read.csv("results/reasons_visit/visits_distances_macao_23_max_gather.csv")[,-c(1:4,6:9)]
visits_dist_enyelle <- read.csv("results/reasons_visit/visits_distances_enyelle_max_gather.csv")[,-c(1:6,8:9)]
visits_dist_betou <- read.csv("results/reasons_visit/visits_distances_betou_max_gather.csv")[,-c(1:6,8:9)]
visits_dist_minganga_22 <- read.csv("results/reasons_visit/visits_distances_minganga_22_max_gather.csv")[,-c(1:6,8:9)]
visits_dist_minganga_23 <- read.csv("results/reasons_visit/visits_distances_minganga_23_max_gather.csv")[,-c(1:5, 7:11)]
...
for (region_name in names(region_datasets)) {
  ...
  write.csv(summary_stats, file = paste0("results/reasons_visit/summary_statistics_", region_name, "_gather.csv"), row.names = FALSE)
}
...
write.csv(combined_summary_stats, "results/reasons_visit/summary_statistics_all_regions_gather.csv", row.names = FALSE)
...
write.csv(summary_df, "results/reasons_visit/summary_statistics_gather.csv", row.names = FALSE)
...
ggsave("results/reasons_visit/distance_gather_by_sex.png", width = 6.5, height=5)


# MAKE PLOTS, DO CALCULATIONS
visits_dist_all <- read.csv("results/reasons_visit/dist_everyone_gather.csv")[,-1]
...
write.csv(sum_df_by_age_sex, "results/reasons_visit/sum_df_by_age_sex_gather.csv")
write.csv(sum_df_by_age, "results/reasons_visit/sum_df_by_age_gather.csv")
...
write.csv(sum_df_by_age_sex_reg, "results/reasons_visit/sum_df_by_sex_age_reg_gather.csv")
...
pi
ggplot2::ggsave("results/reasons_visit/sex_age_median_from_res_gather.png", width = 7, height=6)
...
ggplot2::ggsave("results/reasons_visit/sex_age_boxplot_with_points_by_region_gather.png", plot = p_region_boxplot, width = 9, height = 11)
...
# Save the faceted boxplot
ggplot2::ggsave("results/reasons_visit/sex_age_boxplot_with_points_by_region_macmin_gather.png", plot = p_region_boxplot_macmin, width = 9, height = 6)
...
write.csv(results, "results/reasons_visit/wilcoxon_results_sex_differences_gather.csv", row.names = FALSE)
...
write.csv(results, "results/reasons_visit/wilcoxon_results_sex_differences_gather_allages.csv", row.names = FALSE)
...
ggplot2::ggsave("results/reasons_visit/sex_age_median_from_res_stats_gather.png", width = 17, height=8)
...
#ggplot2::scale_fill_manual(values=c(MetPalettes$Isfahan1[[1]][4], MetPalettes$Isfahan1[[1]][6]))
ggplot2::ggsave("results/reasons_visit/age_sex_median_from_res_stats_gather.png", width = 11, height=7)
