...
png ("results/reasons_visit_traditional/places_all_regions_just_visit.png", units="in", width=6, height=5.9, res=500)
...
write.csv(visits_dist_macao_22, "results/reasons_visit_traditional/visits_distances_macao_22_max_just_visit.csv")
write.csv(visits_dist_macao_23, "results/reasons_visit_traditional/visits_distances_macao_23_max_just_visit.csv")
write.csv(visits_dist_enyelle, "results/reasons_visit_traditional/visits_distances_enyelle_max_just_visit.csv")
write.csv(visits_dist_betou, "results/reasons_visit_traditional/visits_distances_betou_max_just_visit.csv")
write.csv(visits_dist_minganga_22, "results/reasons_visit_traditional/visits_distances_minganga_22_max_just_visit.csv")
write.csv(visits_dist_minganga_23, "results/reasons_visit_traditional/visits_distances_minganga_23_max_just_visit.csv")
...
write.csv(visits_dist_all, "results/reasons_visit_traditional/dist_everyone_just_visit.csv")
...
write.csv(sum_df_by_age_sex, "results/reasons_visit_traditional/sum_df_by_age_sex_just_visit.csv")
write.csv(sum_df_by_age, "results/reasons_visit_traditional/sum_df_by_age_just_visit.csv")
...
pi
ggplot2::ggsave("results/reasons_visit_traditional/sex_age_median_from_res_just_visit.png", width = 7, height=6)
...
ggplot2::ggsave("results/reasons_visit_traditional/sex_age_median_from_res_stats_just_visit.png", width = 17, height=8)
...
#ggplot2::scale_fill_manual(values=c(MetPalettes$Isfahan1[[1]][4], MetPalettes$Isfahan1[[1]][6]))
ggplot2::ggsave("results/reasons_visit_traditional/age_sex_median_from_res_stats_just_visit.png", width = 11, height=7)

# # READ IN DATA

visits_dist_macao_22 <- read.csv("results/reasons_visit_traditional/visits_distances_macao_22_max_just_visit.csv")[,-c(1:6,8:9)]
visits_dist_macao_23 <- read.csv("results/reasons_visit_traditional/visits_distances_macao_23_max_just_visit.csv")[,-c(1:4, 6:9)]
visits_dist_enyelle <- read.csv("results/reasons_visit_traditional/visits_distances_enyelle_max_just_visit.csv")[,-c(1:6,8:9)]
visits_dist_betou <- read.csv("results/reasons_visit_traditional/visits_distances_betou_max_just_visit.csv")[,-c(1:6,8:9)]
visits_dist_minganga_22 <- read.csv("results/reasons_visit_traditional/visits_distances_minganga_22_max_just_visit.csv")[,-c(1:6,8:9)]
visits_dist_minganga_23 <- read.csv("results/reasons_visit_traditional/visits_distances_minganga_23_max_just_visit.csv")[,-c(1:5, 7:11)]
...
for (region_name in names(region_datasets)) {
  ...
  write.csv(summary_stats, file = paste0("results/reasons_visit_traditional/summary_statistics_", region_name, "_just_visit.csv"), row.names = FALSE)
}
...
write.csv(combined_summary_stats, "results/reasons_visit_traditional/summary_statistics_all_regions_just_visit.csv", row.names = FALSE)
...
write.csv(summary_df, "results/reasons_visit_traditional/summary_statistics_just_visit.csv", row.names = FALSE)
...
ggplot(graph, aes(x = value, fill = category)) +
  ...
  annotate("text", x = mean_vals[2]+62, y = 15, label = round(mean_vals[2], 2),
           color = MetPalettes$Isfahan1[[1]][6], size = 5, vjust = -1) + 
  scale_x_continuous(breaks = seq(0, 1000, by = 100), limits = c(0,350))
ggsave("results/reasons_visit_traditional/distance_just_visit_by_sex_400.png", width = 6.5, height=5)
