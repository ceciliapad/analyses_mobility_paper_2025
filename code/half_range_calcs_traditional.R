...
setwd("/Users/Cecilia/Documents/PhD/Fieldwork/Prelim data/analyses_sept23")
library(ggplot2)
library(ggstatsplot)
library(MetBrewer)

# read files
visits_fit_all <- read.csv("results/half_range_traditional/exploration_range_max_dist_fitness.csv")
visits_dist_all <- read.csv( "results/half_range_traditional/exploration_range_max_dist_everyone.csv")
...
write.csv(sum_df_by_age_sex, "results/half_range_traditional/sum_df_by_age_sex_explor_range.csv")
write.csv(sum_df_by_age, "results/half_range_traditional/sum_df_by_age_explor_range.csv")
...
write.csv(sum_df_by_age_sex_reg, "results/half_range_traditional/sum_df_by_sex_age_reg_explor_range.csv")
...
ggplot2::ggsave("results/half_range_traditional/sex_age_boxplot_with_points_by_region.png", plot = p_region_boxplot, width = 9, height = 11)
...
# Save the faceted boxplot
ggplot2::ggsave("results/half_range_traditional/sex_age_boxplot_with_points_by_region_macmin.png", plot = p_region_boxplot_macmin, width = 9, height = 6)
...
write.csv(results, "results/half_range_traditional/wilcoxon_results_sex_differences.csv", row.names = FALSE)
...
p_region_boxplot
# Save the faceted boxplot
ggplot2::ggsave("results/half_range_traditional/sex_age_boxplot_with_points_by_region_max.png", plot = p_region_boxplot, width = 9, height = 11)
...
p_region_boxplot_macmin
# Save the faceted boxplot
ggplot2::ggsave("results/half_range_traditional/sex_age_boxplot_with_points_by_region_macmin_max.png", plot = p_region_boxplot_macmin, width = 9, height = 6)
...
print(results)
# Optionally save the results to a CSV file
write.csv(results, "results/half_range_traditional/wilcoxon_results_sex_differences_max_dist.csv", row.names = FALSE)
...
ggplot2::ggsave("results/half_range_traditional/sex_age_median_from_res_stats.png", width = 17, height=8)
...
ggplot.component = ggplot2::scale_y_continuous(limits = (c(1, 200)))
ggplot2::scale_fill_manual(values=c(MetPalettes$Isfahan1[[1]][4], MetPalettes$Isfahan1[[1]][6]))
ggplot2::ggsave("results/half_range_traditional/sex_region_median_from_res_stats.png", width = 12, height=10)
...
visits_dist_all %>%
  ...
  ggplot2::scale_y_continuous(limits = c(0, 120))
#ggplot2::scale_fill_manual(values=c(MetPalettes$Isfahan1[[1]][4], MetPalettes$Isfahan1[[1]][6]))
ggplot2::ggsave("results/half_range_traditional/age_sex_median_from_res_stats.png", width = 11, height=7)
...
pi
ggplot2::ggsave("results/half_range_traditional/sex_age_max_from_res.png", width = 7, height=6)
...
#ggplot2::scale_fill_manual(values=c(MetPalettes$Isfahan1[[1]][4], MetPalettes$Isfahan1[[1]][6]))
ggplot2::ggsave("results/half_range_traditional/sex_age_max_from_res_stats.png", width = 17, height=8)
...
#ggplot2::scale_fill_manual(values=c(MetPalettes$Isfahan1[[1]][4], MetPalettes$Isfahan1[[1]][6]))
ggplot2::ggsave("results/half_range_traditional/age_sex_max_from_res_stats.png", width = 11, height=7)

# Histogram of max dist in lifetime
png("results/half_range_traditional/max_dist_MEAN.png",7,7, units="in", res=600)
...
hist((visits_dist_all$max_dist)/1000, breaks=25, main="Maximum distance in lifetime",
     xlab="Max. distance in lifetime (km)", ylim=c(0,250), xlim=c(0,400), col=MetPalettes$Isfahan2[[1]][2])
