...
png ("results/reasons_visit/places_all_regions_just_visit.png", units="in", width=6, height=5.9, res=500)
...
for (i in 1:nrow(dongou_visited)){
  ...
  reason <- str_detect("just_visit", my_reasons)
...
times_just_visit <- vector(length=nrow(visits_dist_dongou))
for (i in 1:nrow(dongou_reasons)) {
  my_reasons <- as.character(dongou_reasons[i,])
  reason <- str_detect("just_visit", my_reasons)
  reasons <- which(reason==TRUE)
  total_just_visit <- length(reasons)
  times_just_visit[i] <- total_just_visit
}
visits_dist_dongou$total_just_visit <- times_just_visit
...
times_just_visit <- vector(length=nrow(visits_dist_enyelle))
...
visits_dist_enyelle$total_just_visit <- times_just_visit
...
times_just_visit <- vector(length=nrow(visits_dist_betou))
...
visits_dist_betou$total_just_visit <- times_just_visit
...
times_just_visit <- vector(length=nrow(visits_dist_macao_22))
...
visits_dist_macao_22$total_just_visit <- times_just_visit
...
times_just_visit <- vector(length=nrow(visits_dist_macao_23))
...
visits_dist_macao_23$total_just_visit <- times_just_visit
...
times_just_visit <- vector(length=nrow(visits_dist_minganga_22))
...
visits_dist_minganga_22$total_just_visit <- times_just_visit
...
times_just_visit <- vector(length=nrow(visits_dist_minganga_23))
...
visits_dist_minganga_23$total_just_visit <- times_just_visit
...
write.csv(visits_dist_dongou, "results/reasons_visit/visits_distances_dongou_max_just_visit.csv")
write.csv(visits_dist_macao_22, "results/reasons_visit/visits_distances_macao_22_max_just_visit.csv")
write.csv(visits_dist_macao_23, "results/reasons_visit/visits_distances_macao_23_max_just_visit.csv")
write.csv(visits_dist_enyelle, "results/reasons_visit/visits_distances_enyelle_max_just_visit.csv")
write.csv(visits_dist_betou, "results/reasons_visit/visits_distances_betou_max_just_visit.csv")
write.csv(visits_dist_minganga_22, "results/reasons_visit/visits_distances_minganga_22_max_just_visit.csv")
write.csv(visits_dist_minganga_23, "results/reasons_visit/visits_distances_minganga_23_max_just_visit.csv")
...
visits_dist_all <- rbind(visits_dist_dongou_red, visits_dist_macao_22_red, visits_dist_macao_23_red,
                         visits_dist_minganga_23_red, visits_dist_minganga_22_red, visits_dist_enyelle_red,
                         visits_dist_betou_red)

write.csv(visits_dist_all, "results/reasons_visit/dist_everyone_just_visit.csv")

# READ IN DATA

visits_dist_dongou <- read.csv("results/reasons_visit/visits_distances_dongou_max_just_visit.csv")[,-c(1:6,8:9)]
visits_dist_macao_22 <- read.csv("results/reasons_visit/visits_distances_macao_22_max_just_visit.csv")[,-c(1:6,8:9)]
visits_dist_macao_23 <- read.csv("results/reasons_visit/visits_distances_macao_23_max_just_visit.csv")[,-c(1:4,6:9)]
visits_dist_enyelle <- read.csv("results/reasons_visit/visits_distances_enyelle_max_just_visit.csv")[,-c(1:6,8:9)]
visits_dist_betou <- read.csv("results/reasons_visit/visits_distances_betou_max_just_visit.csv")[,-c(1:6,8:9)]
visits_dist_minganga_22 <- read.csv("results/reasons_visit/visits_distances_minganga_22_max_just_visit.csv")[,-c(1:6,8:9)]
visits_dist_minganga_23 <- read.csv("results/reasons_visit/visits_distances_minganga_23_max_just_visit.csv")[,-c(1:5, 7:11)]
...
for (region_name in names(region_datasets)) {
  ...
  cols_to_remove <- c("median", "max", "min", "places_visited", "total_just_visit", "Sexe")
  ...
  write.csv(summary_stats, file = paste0("results/reasons_visit/summary_statistics_", region_name, "_just_visit.csv"), row.names = FALSE)
}
...
write.csv(combined_summary_stats, "results/reasons_visit/summary_statistics_all_regions_just_visit.csv", row.names = FALSE)




# Make density plots of distances travelled to just_visit
# separate by sex
...
visits_dist_enyelle_m$total_just_visit <- NULL
...
visits_dist_enyelle_f$total_just_visit <- NULL
...
visits_dist_betou_m$total_just_visit <- NULL
...
visits_dist_betou_f$total_just_visit <- NULL
...
visits_dist_dongou_m$total_just_visit <- NULL
...
visits_dist_dongou_f$total_just_visit <- NULL
...
visits_dist_macao_22_m$total_just_visit <- NULL
...
visits_dist_macao_22_f$total_just_visit <- NULL
...
visits_dist_macao_23_m$total_just_visit <- NULL
...
visits_dist_macao_23_f$total_just_visit <- NULL
...
visits_dist_minganga_22_m$total_just_visit <- NULL
...
visits_dist_minganga_22_f$total_just_visit <- NULL
...
visits_dist_minganga_23_m$total_just_visit <- NULL
...
visits_dist_minganga_23_f$total_just_visit <- NULL
...
# only one woman just_visited
write.csv(summary_df, "results/reasons_visit/summary_statistics_just_visit.csv", row.names = FALSE)
...
ggplot(graph, aes(x = value, fill = category)) +
  ...
  labs(title="Distances travelled to explore",x="Km", y = "Count") +
  ...
  annotate("text", x = mean_vals[1]+60, y = 20, label = round(mean_vals[1], 2),
  ...
  scale_x_continuous(breaks = seq(0, 1000, by = 100), limits = c(0,400))
ggsave("results/reasons_visit/distance_just_visit_by_sex_400.png", width = 6.5, height=5)


# MAKE PLOTS, DO CALCULATIONS


visits_dist_all <- read.csv("results/reasons_visit/dist_everyone_just_visit.csv")[,-1]
...
write.csv(sum_df_by_age_sex, "results/reasons_visit/sum_df_by_age_sex_just_visit.csv")
write.csv(sum_df_by_age, "results/reasons_visit/sum_df_by_age_just_visit.csv")
...
write.csv(sum_df_by_age_sex_reg, "results/reasons_visit/sum_df_by_sex_age_reg_just_visit.csv")
...
p1 <- visits_dist_all %>% dplyr::select(median_dist_km, age, sex) %>%
  ...
  scale_fill_manual(values=c( MetPalettes$Isfahan1[[1]][4], MetPalettes$Isfahan1[[1]][6])) + 
  labs(x = "Age group", y = "Median distance travelled to explore (km)") +
  theme_minimal() +
  ggtitle("just_visit") + 
  geom_boxplot()
...
pi
ggplot2::ggsave("results/reasons_visit/sex_age_median_from_res_just_visit.png", width = 7, height=6)
...
ggplot2::ggsave("results/reasons_visit/sex_age_boxplot_with_points_by_region_just_visit.png", plot = p_region_boxplot, width = 9, height = 11)
...
# Save the faceted boxplot
ggplot2::ggsave("results/reasons_visit/sex_age_boxplot_with_points_by_region_macmin_just_visit.png", plot = p_region_boxplot_macmin, width = 9, height = 6)
...
write.csv(results, "results/reasons_visit/wilcoxon_results_sex_differences_just_visit.csv", row.names = FALSE)
...
write.csv(results, "results/reasons_visit/wilcoxon_results_sex_differences_just_visit_allages.csv", row.names = FALSE)
...
visits_dist_all %>%
  ...
  ggstatsplot::grouped_ggbetweenstats(x = sex, y = "median_dist_km", 
                                      ...
                                      ylab="Median distance travelled to explore (km)",
                                      xlab="Sex",
                                      ggplot.component = ggplot2::scale_y_continuous(limits = (c(1, 300))))
...
ggplot2::ggsave("results/reasons_visit/sex_age_median_from_res_stats_just_visit.png", width = 17, height=8)
...
visits_dist_all %>%
  ...
  ggstatsplot::grouped_ggbetweenstats(x = age, y = median_dist_km, 
                                      ...
                                      palette="Darjeeling1",
                                      pairwise.display = "significant",
                                      ylab="Median distance travelled to just_visit (km)",
                                      xlab="Age group",
                                      ggplot.component = ggplot2::scale_y_continuous(limits = (c(1, 300))))
#ggplot2::scale_y_continuous(limits = c(0, 162)) 
#ggplot2::scale_fill_manual(values=c(MetPalettes$Isfahan1[[1]][4], MetPalettes$Isfahan1[[1]][6]))
ggplot2::ggsave("results/reasons_visit/age_sex_median_from_res_stats_just_visit.png", width = 11, height=7)
