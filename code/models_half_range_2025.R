...
visits_dists_all <- read.csv("results/half_range/exploration_range_max_dist_everyone.csv")
...
m1.prior3b <- c(prior(student_t(3, 3.5, 2), class=Intercept),
                prior(gamma(2, 0.1), class=shape),
                prior(student_t(3, 0, 2.5), class=sd), 
                prior(normal( 0, 2), class=b))

m4.prior_weak <- c(
  prior(student_t(3, 3.5, 2), class = Intercept),  # Log-scale mean ~ log(35 km)
...
saveRDS(hr_model_brm9, file = "models/hr_model_brm_randomslope_region.rds")
saveRDS(hr_model_brm8, file = "models/hr_model_brm_randomintercepts_region.rds")
saveRDS(hr_model_brm10, file = "models/hr_model_brm_randomslope_region_simpler.rds")

# load models
hr_model_brm9 <- readRDS("models/hr_model_brm_randomslope_region.rds")
hr_model_brm10 <- readRDS("models/hr_model_brm_randomslope_region_simpler.rds")
hr_model_brm8 <- readRDS("models/hr_model_brm_randomintercepts_region.rds")
...
ggplot2::ggsave("results/half_range/region_variation_lines_randomslopes.png", width = 10, height = 7)
...
ggplot2::ggsave("results/half_range/region_variation_lines_randomslopes_simpler.png", width = 10, height = 7)
...
ggplot2::ggsave("results/half_range/region_variation_lines_randomintercepts.png", width = 10, height = 7)
...
# Generate the plot with updated axis text and legend labels
marginal_region %>%
...
# Save the plot
ggplot2::ggsave("results/half_range/fitted_preds_sex_age_int_randomslopes_marginal.png", width = 8, height = 7)
...
ggplot2::ggsave("results/half_range/fitted_preds_sex_age_int_randomslopes_simpler_marginal.png", width = 8, height=7)


write.csv(region_predictions_sl, "results/half_range/region_variation_randomslopes_hr.csv")
write.csv(region_predictions_sl_simpler, "results/half_range/region_variation_randomslopes_simpler_hr.csv")
write.csv(region_predictions, "results/half_range/region_variation_randomintercept_hr.csv")
write.csv(marginal_region, "results/half_range/region_variation_randomslope_hr_average_region.csv")
write.csv(marginal_region_8, "results/half_range/region_variation_randomintercept_hr_average_region.csv")
write.csv(marginal_region_10, "results/half_range/region_variation_randomslopes_simpler_hr_average_region.csv")
...
# save comparison
write.csv(loo_compare(loo_m1, loo_m2, loo_m3), "results/half_range/loo_comparison_randomslopes_randomintercepts_hr.csv")

########################
# Now for max distance #
########################
...
m5.prior_weak <- c(
  prior(student_t(3, 5, 2), class = Intercept),  # Reflecting log(150 km)
  prior(gamma(2, 0.1), class = shape),          # Shape parameter
...
# Save model as r object
saveRDS(mr_model_brm9, file = "models/mr_model_brm_randomslope_region.rds")
saveRDS(mr_model_brm8, file = "models/mr_model_brm_randomintercepts_region.rds")
saveRDS(mr_model_brm7, file = "models/mr_model_brm_randomslopes_region_simpler.rds")

# load models
mr_model_brm9 <- readRDS("models/mr_model_brm_randomslope_region.rds")
mr_model_brm8 <- readRDS("models/mr_model_brm_randomintercepts_region.rds")
mr_model_brm7 <- readRDS("models/mr_model_brm_randomslopes_region_simpler.rds")
...
region_predictions_sl %>%
  ...
  scale_color_manual(values = region_darker_colors) +  # Darker central lines
  scale_fill_manual(values = region_colors)     

ggplot2::ggsave("results/half_range/region_variation_lines_randomslopes_max_range.png", width = 10, height = 7)
...
ggplot2::ggsave("results/half_range/region_variation_lines_randomslopes_max_range_simpler.png", width = 10, height = 7)
...
ggplot2::ggsave("results/half_range/region_variation_lines_randomintercepts_max_range.png", width = 10, height = 7)
...
ggplot2::ggsave("results/half_range/fitted_preds_sex_age_int_randomslopes_marginal_max_range.png", width = 8, height=7)
...
ggplot2::ggsave("results/half_range/fitted_preds_sex_age_int_randomintercept_marginal_max_range.png", width = 8, height=7)
...
ggplot2::ggsave("results/half_range/fitted_preds_sex_age_int_randomslopes_marginal_max_range_simpler.png", width = 8, height=7)


write.csv(region_predictions_sl, "results/half_range/region_variation_randomslopes_mr.csv")
write.csv(region_predictions, "results/half_range/region_variation_randomintercept_mr.csv")
write.csv(region_predictions_sl_simpler, "results/half_range/region_variation_randomslopes_mr_simpler.csv")
write.csv(marginal_region, "results/half_range/region_variation_randomslope_mr_average_region.csv")
write.csv(marginal_region_8, "results/half_range/region_variation_randomintercept_mr_average_region.csv")
write.csv(marginal_region_7, "results/half_range/region_variation_randomslopes_simpler_mr_average_region.csv")
...
# save comparison
write.csv(loo_compare(loo_m1, loo_m2, loo_m3), "results/half_range/loo_comparison_randomslopes_randomintercepts_mr.csv")
