...
# read files
enyelle_22 <- read.csv("data/initial/mobility_traditional_nowl/enyelle_2022.csv")
minganga_22 <- read.csv("data/initial/mobility_traditional_nowl/minganga_2022.csv")
macao_22 <- read.csv("data/initial/mobility_traditional_nowl/macao_2022.csv")
minganga_23 <- read.csv("data/initial/mobility_traditional_nowl/minganga_2023.csv")
macao_23 <- read.csv("data/initial/mobility_traditional_nowl/macao_2023.csv")
betou_23 <- read.csv("data/initial/mobility_traditional_nowl/betou_2023.csv")
...
names(macao_visited_22) = sub(pattern = "\\.", replacement = "", x=names(macao_visited_22))
names(macao_visited_22) = sub(pattern = "\\.", replacement = "", x=names(macao_visited_22))
macao_visited_22 <- macao_visited_22[,-c(20,66:67)]
...
macao_reasons_22 <- macao_reasons_22[,-c(1,21,67:101)]
...
write.csv(macao_reasons_22, "data/initial/macao_reasons_22_clean_traditional.csv")
write.csv(macao_visited_22, "data/initial/macao_visits_22_clean_traditional.csv")
...
macao_visited_23 <- macao_visited_23[,-c(56,60:84)]
...
write.csv(macao_reasons_23, "data/initial/macao_reasons_23_clean_traditional.csv")
write.csv(macao_visited_23, "data/initial/macao_visits_23_clean_traditional.csv")
...
minganga_visited_22 <- minganga_visited_22[,-c(1,17,70:85)]
...
minganga_reasons_22 <- minganga_reasons_22[,-c(1,17,70:120)]
...
write.csv(minganga_reasons_22, "data/initial/minganga_reasons_22_clean_traditional.csv")
write.csv(minganga_visited_22, "data/initial/minganga_visits_22_clean_traditional.csv")
...
minganga_visited_23 <- minganga_visited_23[,-c(1,57,61:83)]
...
#names(minganga_reasons ) = gsub(pattern = ".", replacement = "", x = names(minganga_reasons ))
names(minganga_reasons_23 ) = gsub(pattern = "Regionsvisités..au.moins.une.fois.....", replacement = "", x = names(minganga_reasons_23 ))
minganga_reasons_23 <- minganga_reasons_23[,-c(1:55, 111,116:119)]

minganga_reasons_23 <- minganga_reasons_23[,-c(56)]
...
write.csv(minganga_reasons_23, "data/initial/minganga_reasons_23_clean_traditional.csv")
write.csv(minganga_visited_23, "data/initial/minganga_visits_23_clean_traditional.csv")
...
#names(enyelle_visited ) = gsub(pattern = "Visité?", replacement = "", x = names(enyelle_visited ))
#names(enyelle_visited ) = gsub(pattern = ".", replacement = "", x = names(enyelle_visited ))
enyelle_visited <- enyelle_visited[,-c(1,34,80)]
...
#names(enyelle_reasons ) = gsub(pattern = ".", replacement = "", x = names(enyelle_reasons ))
enyelle_reasons <- enyelle_reasons[,-c(1,34,80:125)]
...
write.csv(enyelle_reasons, "data/initial/enyelle_reasons_clean_traditional.csv")
write.csv(enyelle_visited, "data/initial/enyelle_visited_clean_traditional.csv")
...
write.csv(betou_reasons, "data/initial/betou_reasons_clean_traditional.csv")
write.csv(betou_visited, "data/initial/betou_visited_clean_traditional.csv")
...
save.image("results/intermediate/reasons_clean_traditional.RData")
...
png ("results/reasons_visit_traditional/places_all_regions_hunt.png", units="in", width=6, height=5.9, res=500)
...
write.csv(visits_dist_macao_22, "results/reasons_visit_traditional/visits_distances_macao_22_max_hunt.csv")
write.csv(visits_dist_macao_23, "results/reasons_visit_traditional/visits_distances_macao_23_max_hunt.csv")
write.csv(visits_dist_enyelle, "results/reasons_visit_traditional/visits_distances_enyelle_max_hunt.csv")
write.csv(visits_dist_betou, "results/reasons_visit_traditional/visits_distances_betou_max_hunt.csv")
write.csv(visits_dist_minganga_22, "results/reasons_visit_traditional/visits_distances_minganga_22_max_hunt.csv")
write.csv(visits_dist_minganga_23, "results/reasons_visit_traditional/visits_distances_minganga_23_max_hunt.csv")
...
write.csv(visits_dist_all, "results/reasons_visit_traditional/dist_everyone_hunt.csv")
...
write.csv(sum_df_by_age_sex, "results/reasons_visit_traditional/sum_df_by_age_sex_hunt.csv")
write.csv(sum_df_by_age, "results/reasons_visit_traditional/sum_df_by_age_hunt.csv")
...
pi
ggplot2::ggsave("results/reasons_visit_traditional/sex_age_median_from_res_hunt.png", width = 7, height=6)
...
ggplot2::ggsave("results/reasons_visit_traditional/sex_age_median_from_res_stats_hunt.png", width = 17, height=8)
...
#ggplot2::scale_fill_manual(values=c(MetPalettes$Isfahan1[[1]][4], MetPalettes$Isfahan1[[1]][6]))
ggplot2::ggsave("results/reasons_visit_traditional/age_sex_median_from_res_stats_hunt.png", width = 11, height=7)


# # READ IN DATA

visits_dist_macao_22 <- read.csv("results/reasons_visit_traditional/visits_distances_macao_22_max_hunt.csv")[,-c(1:6,8:9)]
visits_dist_macao_23 <- read.csv("results/reasons_visit_traditional/visits_distances_macao_23_max_hunt.csv")[,-c(1:4, 6:9)]
visits_dist_enyelle <- read.csv("results/reasons_visit_traditional/visits_distances_enyelle_max_hunt.csv")[,-c(1:6,8:9)]
visits_dist_betou <- read.csv("results/reasons_visit_traditional/visits_distances_betou_max_hunt.csv")[,-c(1:6,8:9)]
visits_dist_minganga_22 <- read.csv("results/reasons_visit_traditional/visits_distances_minganga_22_max_hunt.csv")[,-c(1:6,8:9)]
visits_dist_minganga_23 <- read.csv("results/reasons_visit_traditional/visits_distances_minganga_23_max_hunt.csv")[,-c(1:5, 7:11)]
...
for (region_name in names(region_datasets)) {
  ...
  write.csv(summary_stats, file = paste0("results/reasons_visit_traditional/summary_statistics_", region_name, "_hunt.csv"), row.names = FALSE)
}
...
write.csv(combined_summary_stats, "results/reasons_visit_traditional/summary_statistics_all_regions_hunt.csv", row.names = FALSE)
...
write.csv(summary_df, "results/reasons_visit_traditional/summary_statistics_hunt.csv", row.names = FALSE)
...
ggplot(graph, aes(x = value, fill = category)) +
  ...
  annotate("text", x = mean_vals[1]+50, y = 20, label = round(mean_vals[1], 2),
           color = MetPalettes$Isfahan1[[1]][6], size = 5, vjust = -1) + 
  scale_x_continuous(breaks = seq(0, 1000, by = 100), limits = c(0,100))
ggsave("results/reasons_visit_traditional/distance_hunt_by_sex.png", width = 6.5, height=5)
