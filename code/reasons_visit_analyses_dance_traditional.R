...
png ("results/reasons_visit_traditional/places_all_regions_dance.png", units="in", width=6, height=5.9, res=500)
...
for (i in 1:nrow(dongou_visited)){
  ...
  reason <- str_detect("dance|funeral|ritual|announce_marriage|hg_politics", my_reasons)
...
write.csv(visits_dist_macao_22, "results/reasons_visit_traditional/visits_distances_macao_22_max_dance.csv")
write.csv(visits_dist_macao_23, "results/reasons_visit_traditional/visits_distances_macao_23_max_dance.csv")
write.csv(visits_dist_enyelle, "results/reasons_visit_traditional/visits_distances_enyelle_max_dance.csv")
write.csv(visits_dist_betou, "results/reasons_visit_traditional/visits_distances_betou_max_dance.csv")
write.csv(visits_dist_minganga_22, "results/reasons_visit_traditional/visits_distances_minganga_22_max_dance.csv")
write.csv(visits_dist_minganga_23, "results/reasons_visit_traditional/visits_distances_minganga_23_max_dance.csv")
...
write.csv(visits_dist_all, "results/reasons_visit_traditional/dist_everyone_dance.csv")
...
write.csv(sum_df_by_age_sex, "results/reasons_visit_traditional/sum_df_by_age_sex_dance.csv")
write.csv(sum_df_by_age, "results/reasons_visit_traditional/sum_df_by_age_dance.csv")
...
pi
ggplot2::ggsave("results/reasons_visit_traditional/sex_age_median_from_res_dance.png", width = 7, height=6)
...
ggplot2::ggsave("results/reasons_visit_traditional/sex_age_median_from_res_stats_dance.png", width = 17, height=8)
...
#ggplot2::scale_fill_manual(values=c(MetPalettes$Isfahan1[[1]][4], MetPalettes$Isfahan1[[1]][6]))
ggplot2::ggsave("results/reasons_visit_traditional/age_sex_median_from_res_stats_dance.png", width = 11, height=7)

# # READ IN DATA

visits_dist_macao_22 <- read.csv("results/reasons_visit_traditional/visits_distances_macao_22_max_dance.csv")[,-c(1:6,8:9)]
visits_dist_macao_23 <- read.csv("results/reasons_visit_traditional/visits_distances_macao_23_max_dance.csv")[,-c(1:4, 6:9)]
visits_dist_enyelle <- read.csv("results/reasons_visit_traditional/visits_distances_enyelle_max_dance.csv")[,-c(1:6,8:9)]
visits_dist_betou <- read.csv("results/reasons_visit_traditional/visits_distances_betou_max_dance.csv")[,-c(1:6,8:9)]
visits_dist_minganga_22 <- read.csv("results/reasons_visit_traditional/visits_distances_minganga_22_max_dance.csv")[,-c(1:6,8:9)]
visits_dist_minganga_23 <- read.csv("results/reasons_visit_traditional/visits_distances_minganga_23_max_dance.csv")[,-c(1:5, 7:11)]
...
for (region_name in names(region_datasets)) {
  ...
  write.csv(summary_stats, file = paste0("results/reasons_visit_traditional/summary_statistics_", region_name, "_dance.csv"), row.names = FALSE)
}
...
write.csv(combined_summary_stats, "results/reasons_visit_traditional/summary_statistics_all_regions_dance.csv", row.names = FALSE)
...
#hist(visits_dist_enyelle/1000, main="Distance travelled for rituals members")
...
write.csv(summary_df, "results/reasons_visit_traditional/summary_statistics_dance.csv", row.names = FALSE)
...
ggplot(graph, aes(x = value, fill = category)) +
  ...
  annotate("text", x = mean_vals[1]+53, y = 20, label = round(mean_vals[1], 2),
  ...
  annotate("text", x = mean_vals[2]+55, y = 17, label = round(mean_vals[2], 2),
           color = MetPalettes$Isfahan1[[1]][6], size =5, vjust = -1) + 
  scale_x_continuous(breaks = seq(0, 1000, by = 100), limits = c(0,200))
ggsave("results/reasons_visit_traditional/distance_dance_by_sex_200.png", width = 6.5, height=5)
