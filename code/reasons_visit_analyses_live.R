...
png ("results/reasons_visit/places_all_regions_live.png", units="in", width=6, height=5.9, res=500)
...
times_live <- vector(length=nrow(visits_dist_dongou))
...
visits_dist_dongou$total_live <- times_live
...
write.csv(visits_dist_dongou, "results/reasons_visit/visits_distances_dongou_max_live.csv")
write.csv(visits_dist_macao_22, "results/reasons_visit/visits_distances_macao_22_max_live.csv")
write.csv(visits_dist_macao_23, "results/reasons_visit/visits_distances_macao_23_max_live.csv")
write.csv(visits_dist_enyelle, "results/reasons_visit/visits_distances_enyelle_max_live.csv")
write.csv(visits_dist_betou, "results/reasons_visit/visits_distances_betou_max_live.csv")
write.csv(visits_dist_minganga_22, "results/reasons_visit/visits_distances_minganga_22_max_live.csv")
write.csv(visits_dist_minganga_23, "results/reasons_visit/visits_distances_minganga_23_max_live.csv")
...
write.csv(visits_dist_all, "results/reasons_visit/dist_everyone_live.csv")

# READ IN DATA

visits_dist_dongou <- read.csv("results/reasons_visit/visits_distances_dongou_max_live.csv")[,-c(1:6,8:9)]
visits_dist_macao_22 <- read.csv("results/reasons_visit/visits_distances_macao_22_max_live.csv")[,-c(1:6,8:9)]
visits_dist_macao_23 <- read.csv("results/reasons_visit/visits_distances_macao_23_max_live.csv")[,-c(1:4,6:9)]
visits_dist_enyelle <- read.csv("results/reasons_visit/visits_distances_enyelle_max_live.csv")[,-c(1:6,8:9)]
visits_dist_betou <- read.csv("results/reasons_visit/visits_distances_betou_max_live.csv")[,-c(1:6,8:9)]
visits_dist_minganga_22 <- read.csv("results/reasons_visit/visits_distances_minganga_22_max_live.csv")[,-c(1:6,8:9)]
visits_dist_minganga_23 <- read.csv("results/reasons_visit/visits_distances_minganga_23_max_live.csv")[,-c(1:5, 7:11)]
...
for (region_name in names(region_datasets)) {
  ...
  write.csv(summary_stats, file = paste0("results/reasons_visit/summary_statistics_", region_name, "_live.csv"), row.names = FALSE)
}
...
write.csv(combined_summary_stats, "results/reasons_visit/summary_statistics_all_regions_live.csv", row.names = FALSE)
...
visits_dist_dongou_m$total_live <- NULL
...
visits_dist_dongou_f$total_live <- NULL
...
write.csv(summary_df, "results/reasons_visit/summary_statistics_live.csv", row.names = FALSE)
...
ggsave("results/reasons_visit/distance_live_by_sex_200.png", width = 6.5, height=5)
...
write.csv(sum_df_by_age_sex, "results/reasons_visit/sum_df_by_age_sex_live.csv")
write.csv(sum_df_by_age, "results/reasons_visit/sum_df_by_age_live.csv")
...
pi
ggplot2::ggsave("results/reasons_visit/sex_age_median_from_res_live.png", width = 7, height=6)
...
ggplot2::ggsave("results/reasons_visit/sex_age_median_from_res_stats_live.png", width = 17, height=8)
...
#ggplot2::scale_fill_manual(values=c(MetPalettes$Isfahan1[[1]][4], MetPalettes$Isfahan1[[1]][6]))
ggplot2::ggsave("results/reasons_visit/age_sex_median_from_res_stats_live.png", width = 11, height=7)
